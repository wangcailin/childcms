<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/Users/wangcailin/Web/CMS/fastadmin/public/../application/admin/view/category/add.html";i:1508220324;s:88:"/Users/wangcailin/Web/CMS/fastadmin/public/../application/admin/view/layout/default.html";i:1507971686;s:85:"/Users/wangcailin/Web/CMS/fastadmin/public/../application/admin/view/common/meta.html";i:1507971686;s:87:"/Users/wangcailin/Web/CMS/fastadmin/public/../application/admin/view/common/script.html";i:1507971686;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-type" class="control-label col-xs-12 col-sm-2"><?php echo __('Model'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-type" data-rule="required" class="form-control selectpicker" name="row[modelid]">
                <?php if(is_array($typeList) || $typeList instanceof \think\Collection || $typeList instanceof \think\Paginator): if( count($typeList)==0 ) : echo "" ;else: foreach($typeList as $key=>$vo): ?>
                <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',""))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        <label for="c-listorder" class="control-label col-xs-12 col-sm-2"><?php echo __('Listorder'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-listorder" class="form-control" name="row[listorder]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label for="c-status" class="control-label col-xs-12 col-sm-2"><?php echo __('Status'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[ismenu]', ['1'=>__('Normal'), '0'=>__('Hidden')]); ?>
        </div>
    </div>
